...
public class Engine implements Runnable {
    ...
    public static final String SUCCESS = "%.2f kg of %s successfully processed!";
    ...
    public static final String STATUS = "Energy: %.2f Capital: %.2f";
    ...
    public void run() {
        ...
        while (!line.equals("TimeToRecycle")) {
            ...
            switch (cmdType) {
                case "ProcessGarbage":
                    this.writer.writeln(this.processGarbage(cmdArgs[1]));
                    break;
                case "Status":
                    this.writer.writeln(this.getStatus());
                    break;
                default:
                    this.writer.writeln(INVALID_COMMAND);
            }
